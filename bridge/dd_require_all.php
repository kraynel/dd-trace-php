...
require __DIR__ . '/../src/DDTrace/Transport/Jaeger/TUDPTransport.php';
require __DIR__ . '/../src/DDTrace/Transport/Jaeger/Jaeger.php';
require __DIR__ . '/../src/DDTrace/Transport/Jaeger/Thrift/Agent/Agent_emitBatch_args.php';
require __DIR__ . '/../src/DDTrace/Transport/Jaeger/Thrift/Agent/AgentIf.php';
require __DIR__ . '/../src/DDTrace/Transport/Jaeger/Thrift/Agent/AgentClient.php';
require __DIR__ . '/../src/DDTrace/Transport/Jaeger/Thrift/Span.php';
require __DIR__ . '/../src/DDTrace/Transport/Jaeger/Thrift/TagType.php';
require __DIR__ . '/../src/DDTrace/Transport/Jaeger/Thrift/Tag.php';
require __DIR__ . '/../src/DDTrace/Transport/Jaeger/Thrift/Batch.php';
require __DIR__ . '/../src/DDTrace/Transport/Jaeger/Thrift/Process.php';
...
require __DIR__ . '/../src/DDTrace/Encoders/Jaeger.php';
