...
class Batch
{
    ...
    static public $_TSPEC = array(
        1 => array(
            ...
            'isRequired' => true,
            'type' => TType::STRUCT,
            'class' => '\DDTrace\Transport\Jaeger\Thrift\Process',
        ),
        2 => array(
            'var' => 'spans',
            'isRequired' => true,
            ...
            'elem' => array(
                'type' => TType::STRUCT,
                'class' => '\DDTrace\Transport\Jaeger\Thrift\Span',
                ),
        ),
    );

    /**
     * @var \DDTrace\Transport\Jaeger\Thrift\Process
     */
    public $process = null;
    /**
     * @var \DDTrace\Transport\Jaeger\Thrift\Span[]
     */
    public $spans = null;
            ...
            switch ($fid) {
                case 1:
                    if ($ftype == TType::STRUCT) {
                        $this->process = new \DDTrace\Transport\Jaeger\Thrift\Process();
                ...
                case 2:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i39 = 0; $_i39 < $_size35; ++$_i39) {
                            $elem40 = null;
                            $elem40 = new \DDTrace\Transport\Jaeger\Thrift\Span();
