...
class CollectorClient implements \DDTrace\Transport\Jaeger\Thrift\CollectorIf
{
    ...
    {
        $args = new \DDTrace\Transport\Jaeger\Thrift\Collector_submitBatches_args();
    ...
    public function recv_submitBatches()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\DDTrace\Transport\Jaeger\Thrift\Collector_submitBatches_result',
            ...
            $result = new \DDTrace\Transport\Jaeger\Thrift\Collector_submitBatches_result();
