...
class Span
{
    ...
    static public $_TSPEC = array(
        ...
        6 => array(
            ...
            'elem' => array(
                'type' => TType::STRUCT,
                'class' => '\DDTrace\Transport\Jaeger\Thrift\Agent\Zipkin\Annotation',
                ),
        ),
        8 => array(
            ...
            'elem' => array(
                'type' => TType::STRUCT,
                'class' => '\DDTrace\Transport\Jaeger\Thrift\Agent\Zipkin\BinaryAnnotation',
                ),
        ),
        9 => array(
            'var' => 'debug',
    ...
    /**
     * @var \DDTrace\Transport\Jaeger\Thrift\Agent\Zipkin\Annotation[]
     */
    public $annotations = null;
    /**
     * @var \DDTrace\Transport\Jaeger\Thrift\Agent\Zipkin\BinaryAnnotation[]
     */
                ...
                case 6:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i4 = 0; $_i4 < $_size0; ++$_i4) {
                            $elem5 = null;
                            $elem5 = new \DDTrace\Transport\Jaeger\Thrift\Agent\Zipkin\Annotation();
                ...
                case 8:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i10 = 0; $_i10 < $_size6; ++$_i10) {
                            $elem11 = null;
                            $elem11 = new \DDTrace\Transport\Jaeger\Thrift\Agent\Zipkin\BinaryAnnotation();
