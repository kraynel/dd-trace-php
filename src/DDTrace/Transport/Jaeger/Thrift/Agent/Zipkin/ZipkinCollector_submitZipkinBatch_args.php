...
class ZipkinCollector_submitZipkinBatch_args
{
    ...
    static public $_TSPEC = array(
        1 => array(
            ...
            'elem' => array(
                'type' => TType::STRUCT,
                'class' => '\DDTrace\Transport\Jaeger\Thrift\Agent\Zipkin\Span',
                ),
        ),
    );

    /**
     * @var \DDTrace\Transport\Jaeger\Thrift\Agent\Zipkin\Span[]
     */
    public $spans = null;
                ...
                case 1:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i18 = 0; $_i18 < $_size14; ++$_i18) {
                            $elem19 = null;
                            $elem19 = new \DDTrace\Transport\Jaeger\Thrift\Agent\Zipkin\Span();
