...
class Annotation
{
    ...
    static public $_TSPEC = array(
        ...
        3 => array(
            ...
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\DDTrace\Transport\Jaeger\Thrift\Agent\Zipkin\Endpoint',
        ),
    );
     ...
     * 
     * @var \DDTrace\Transport\Jaeger\Thrift\Agent\Zipkin\Endpoint
     */
    public $host = null;
            ...
            switch ($fid) {
                ...
                case 3:
                    if ($ftype == TType::STRUCT) {
                        $this->host = new \DDTrace\Transport\Jaeger\Thrift\Agent\Zipkin\Endpoint();
