...
class Collector_submitBatches_result
{
    ...
    static public $_TSPEC = array(
        0 => array(
            ...
            'elem' => array(
                'type' => TType::STRUCT,
                'class' => '\DDTrace\Transport\Jaeger\Thrift\BatchSubmitResponse',
                ),
        ),
    );

    /**
     * @var \DDTrace\Transport\Jaeger\Thrift\BatchSubmitResponse[]
     */
    public $success = null;
                ...
                case 0:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i53 = 0; $_i53 < $_size49; ++$_i53) {
                            $elem54 = null;
                            $elem54 = new \DDTrace\Transport\Jaeger\Thrift\BatchSubmitResponse();
