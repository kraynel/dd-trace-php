...
class Span
{
    ...
    static public $_TSPEC = array(
        ...
        6 => array(
            ...
            'elem' => array(
                'type' => TType::STRUCT,
                'class' => '\DDTrace\Transport\Jaeger\Thrift\SpanRef',
                ),
        ),
        7 => array(
            'var' => 'flags',
        ...
        10 => array(
            ...
            'elem' => array(
                'type' => TType::STRUCT,
                'class' => '\DDTrace\Transport\Jaeger\Thrift\Tag',
                ),
        ),
        11 => array(
            'var' => 'logs',
            ...
            'elem' => array(
                'type' => TType::STRUCT,
                'class' => '\DDTrace\Transport\Jaeger\Thrift\Log',
                ),
        ),
    );
    ...
    /**
     * @var \DDTrace\Transport\Jaeger\Thrift\SpanRef[]
     */
    ...
    /**
     * @var \DDTrace\Transport\Jaeger\Thrift\Tag[]
     */
    public $tags = null;
    /**
     * @var \DDTrace\Transport\Jaeger\Thrift\Log[]
     */
    public $logs = null;
                ...
                case 6:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i11 = 0; $_i11 < $_size7; ++$_i11) {
                            $elem12 = null;
                            $elem12 = new \DDTrace\Transport\Jaeger\Thrift\SpanRef();
                ...
                case 10:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i17 = 0; $_i17 < $_size13; ++$_i17) {
                            $elem18 = null;
                            $elem18 = new \DDTrace\Transport\Jaeger\Thrift\Tag();
                ...
                case 11:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i23 = 0; $_i23 < $_size19; ++$_i23) {
                            $elem24 = null;
                            $elem24 = new \DDTrace\Transport\Jaeger\Thrift\Log();
